...
In the next tabs to the right, graphs and texts will provide insights into the various aspects of music that I dived into for this project. I hope you'll find it interesting to read!
...
First, acousticness: a surprising difference between the 2 Dogs playlists and the playlist humans
...
### Combined analysis of 4 key musical elements, observed over the 4 playlists {data-commentary-width="450"}
...
### Analysis of 2 **'archetype'** songs in terms of chroma features (providing pitch class insights) as can be seen in chromagrams {data-commentary-width="600"}
...
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/0SLtSDSjPupBUmrXtUNgPE?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe> {width="8cm", height="5cm}
