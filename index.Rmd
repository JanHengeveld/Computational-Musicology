...
When listening to the extreme outliers regarding tempo I can safely assume that the Spotify API isn't working flawlessly: e.g. the 'fastest' song from the dogsscience playlist is "Chorale Prelude No. 5 “Ach bleib bei uns Herr Jesu Christ” in B-Flat Major, BWV 649 (Harp Version)"
and analysed at 200 BPM by Spotify: https://open.spotify.com/track/2Chgj5q0NgvBlFvzYVJvUa?si=5592371b98464c2d
...
tempogramstrueforweightless <- singlehumanscience |>
  ...
  labs(x = "Time (s)", title = "Weightless", y = "Tempo (BPM)") +
  theme_classic()
  grid.arrange(tempogramsfalseforweightless, tempogramstrueforweightless, ncol = 1)
```
